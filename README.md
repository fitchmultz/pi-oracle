...
> Status: experimental public beta. Validated on macOS and Linux with Chromium-family browsers and `pi` 0.65.0+. Normal oracle jobs run in an isolated browser profile, not your active browser window.
